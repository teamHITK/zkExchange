...
var zk_data_prep_1 = require("@0xagnish/zk-data-prep");
var snarkjs_1 = require("snarkjs");
var buildInput_1 = require("./buildInput");
/**
    ...
    Prover.prototype.generateProofForUser = function (userIndex) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        circomInput = (0, buildInput_1.default)(this._tree, userIndex, this._assetsSum);
                    ...
                    case 1:
                        ...
                        entry = new zk_data_prep_1.Entry(circomInput.username, circomInput.balance);
                        fullProof = {
                            entry: entry,
